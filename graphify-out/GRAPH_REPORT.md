...
Cohesion: 0.40
Nodes (4): Always-loaded components, How to add one, Notes, Why the extra command
...
## Knowledge Gaps
- **51 isolated node(s):** `AN_SAVE_FIELDS`, `_symBounds`, `AN_PALETTE`, `AN_PREFIX`, `AN_UNIT_ROWS` (+46 more)
